...
export const Home = () => {
  ...
  return (
    <div className='flex flex-col justify-center'>
      <Header />
      <div className='w-full max-w-7xl flex mx-auto flex-col mt-16 gap-12'>
        <div className='flex justify-between'>
          <h1 className='text-xl font-semibold'>Wishlist (4)</h1>
          <button className='text-xl border border-gray-400 px-8 py-3 rounded shadow-sm'>Move All to Bag</button>
        </div>
      ...
      <div className='w-full max-w-7xl flex mx-auto flex-col mt-16 gap-12'>
        <div className='flex justify-between'>
          ...
          <button className='text-xl border border-gray-400 px-8 py-3 rounded shadow-sm'>See All</button>
        </div>
